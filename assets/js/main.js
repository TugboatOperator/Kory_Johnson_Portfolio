  ...
  var imJs = {
    ...
    contactForm: function () {
      $(".rwt-dynamic-form").on("submit", function (e) {
        ...
        $.ajax({
          url: "https://formspree.io/f/mjkrzlrj",
          type: "POST",
          dataType: "json",
          data: data,
          headers: {
          ...
          success: function (response) {
            ...
            _self
              .find(".rn-btn")
              .after(
                '<div class="success-msg"><p>Message sent successfully!</p></div>'
              );
          ...
          error: function (xhr, status, error) {
            ...
            _self
              .find(".rn-btn")
              .after(
                '<div class="error-msg"><p>Error sending message. Please try again.</p></div>'
              );
          },
        });
      });
